...
**`Config.Debug.xcconfig`** - Contains:
...
!Config.Debug.xcconfig   # Safe to commit
...
1. **Update `.gitignore`**:
   ...
   !Config.Debug.xcconfig   # Allow Debug config
